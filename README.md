# PaySubs_WooCommerce
## DPO PayGate PaySubs1 (VCS) WooCommerce plugin v1.0.3 for WooCommerce v3.5.1
...
Please navigate to the [releases page](https://github.com/PayGate/PaySubs_WooCommerce/releases), download the latest release (v1.0.3) and unzip. You will them be able to follow the integration guide PDF which is included in the zip.
